					...
					<div class="tab-content">
						<div class="tab-pane active " id="tab_1">
							...
							<p>All borrowers go through a thorough financial, personal,
								...
								through the use of sophisticated technology and machine learning
								algorithms working in tandem with experienced professionals.</p>
							...
							<p>Financial Institutions provide limited products for
								...
								period of time. Finally, equity markets are highly volatile and
								require a significant holding capacity and risk appetite and
								even then returns are not guaranteed.</p>
							<p>Lendbox fills this gap by offering a new fixed income
								asset class which is safe and secure and offers ROIs of as high
								as 36%.</p>
							<p>You may have been refused a loan from high street banks or
								other traditional financial institutions even though you are
								more than capable of repaying your loans. This may be due to an
								unconventional profile or something that banks might consider a
								"bad credit" profile.</p>
							...
							<p>Some of the key advantages of lending through Lendbox are :</p>
							
							<ul class="list-unstyled">
								<li><i class="fa fa-star"></i>Attractive returns of as high
									as 36%</li>
								...
								<li><i class="fa fa-star"></i>Detailed credit assessment
									through sophisticated technology and experienced professionals</li>
								...
								<li><i class="fa fa-star"></i>Opportunity to negotiate with
									the borrower before closing a deal</li>
							...
							<ul class="list-unstyled">
								<li><i class="fa fa-star"></i>Net Salary and expenditure
									trends</li>
								<li><i class="fa fa-star"></i>Educational Qualification and
									Professional History</li>
								<li><i class="fa fa-star"></i>Professional industry type
									and total asset holding</li>
								<li><i class="fa fa-star"></i>Number of total jobs held and
									frequency of job changes</li>
								...
								<li><i class="fa fa-star"></i>Online spending behavior and
									many other non-traditional data points</li>
							</ul>
							<p>In total, Lendbox reviews over 1000 data points to ensure
								that our system accurately profiles a borrowers and our
						...
						<div class="tab-pane" id="tab_2">
							...
							<ul class="list-unstyled">
								...
								<li><i class="fa fa-star"></i>You must be more than 21
									years old</li>
								<li><i class="fa fa-star"></i>You must have a valid Indian
									bank account</li>
								<li><i class="fa fa-star"></i>You must have a valid PAN
									card</li>
								<li><i class="fa fa-star"></i>You must abide by Lendbox's
									Terms & Conditions</li>
								<li><i class="fa fa-star"></i>You must adhere to Investor's
									code of conduct</li>
						...
						<div class="tab-pane" id="tab_3">
							<div class="desc text-left">
								<p>Investing at Lendbox is very similar to stock market
									...
									about investing in people through a transparent, convenient and
									efficient process.</p>
								...
								<ul class="list-unstyled">
									<li><i class="fa fa-star"></i>Registration : Register your
										personal and professional details on Lendbox. We do basic
										checks on the information provided and ask for some
										documentation<!-- as a proof of identity, address, DOB,
											signature, contact, income. --></li>
									<li><i class="fa fa-star"></i>Account activation: Lendbox
										verifies the information provided and activates the account</li>
									...
									<li><i class="fa fa-star"></i>Deal close and agreement
										...
										signing</li>
									<li><i class="fa fa-star"></i>EMI payments: All borrowers
										are encouraged to issue standing instructions in favour of
										their investors to make monthly payments easy and paperfree</li>
								...
								<p>We may put limitations on your account at any time if we
									believe it is in order to comply with our legal obligations.</p>
						...
						<div class="tab-pane" id="tab_4">
							<div class="desc text-left">
								<p>The returns you earn by investing through Lendbox depend
									on your risk appetite. So, you decide the risk profile of
									borrowers you want to invest in and Lendbox will facilitate the
									process afterwords.</p>
								<p>Non-Payment of EMI: In case the borrowers do not transfer
									the EMI by the due date, additional penal interest would be
									applicable as per the loan agreement signed between the
									Investors and their respective borrowers and will be applied to
									the due amount for the duration of delay, which Borrowers will
									be liable to pay the Investor.</p>
								...
								<div class="desc text-left">
									<ul class="list-unstyled">
										<li><i class="fa fa-star"></i>The data provided on the
											website is directed solely at and is for use solely by people
											mentioned in the terms and conditions applying to lenders.
											The content provided on the website is not intended for
											distribution to, or use by, any person or entity in any
											jurisdiction where such distribution or use would be contrary
											to applicable law or regulation.</li>
										<li><i class="fa fa-star"></i>You are permitted to
											download and print content from this platform solely for your
											own personal use to the extent required to use the services
											provided on this website. Lendbox supplied content must not
											be copied or reproduced, modified, redistributed, used or
											otherwise dealt with for any other reason without our express
											written consent.</li>
										<li><i class="fa fa-star"></i>We are not responsible for
											content downloaded or posted by Investors on the platform.</li>
										<li><i class="fa fa-star"></i>You agree to use the
											platform only for lawful purposes and in a way which does not
											infringe the rights of any anyone else or restrict or inhibit
											anyone else's use and enjoyment of the platform.</li>
										<li><i class="fa fa-star"></i>You agree not to use the
											Lendbox website or any information accessible on or obtained
											from it for the purpose of canvassing or soliciting any
											person or enticing any person away from Lendbox.</li>
										<li><i class="fa fa-star"></i>You guarantee that you have
											taken all reasonable precautions to ensure that any
											information you upload or otherwise submit to the website is
											free from viruses and anything else which may have a
											contaminating or destructive effect on any part of the
											website or any of its technology.</li>
										<li><i class="fa fa-star"></i>You are responsible for all
											costs incurred by you in accessing the platform.</li>
										<li><i class="fa fa-star"></i>The platform may contain
											links to websites. We accept no responsibility or liability
											for any material supplied by or contained on any third party
											website which is linked from or to the platform, or any use
											of personal data by such third party.</li>
									</ul>
								</div>
								<!--//table-responsive-->
							</div>
