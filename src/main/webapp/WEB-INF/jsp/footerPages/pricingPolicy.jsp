...
<title>Pricing Policy | Fundhouse</title>
...
<body class="hold-transition skin-blue layout-top-nav">
	...
	<jsp:include page="../mainHeader.jsp" flush="true"></jsp:include>
		<section class="section">
			...
			<h2 class="text-center">PRICING POLICY</h2>
			<p>&nbsp;</p>
				<div class="col-lg-7 col-md-7">
				<h4><strong>REGISTRATION FEES &ndash; &#8377; 1,000</strong></h4>
				<p>
					Fundhouse charges &#8377; 1,000 as Registration fees, and it needs to be paid on or after registration. If Fundhouse could not get you a loan in two weeks, then it would refund you &#8377; 500 out of &#8377; 1000 registration fees.
				</p>
				<p><strong>Loan Processing Fees: 2 &ndash; 5&#x25</strong></p>
