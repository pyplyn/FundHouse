...
<title>Testimonials | Fundhouse</title>
				...
				<div class="index-testimonial-card-div">
					...
					<div class="index-testimonial-card-footer">
						<div class="row">
							<div class="col-md-9" style="margin-right: 10%;">
								<div class="row text-right">
									<span class="the-blue-text">Anonymous</span>
								</div>
								<div class="row text-right">Borrower at Fund House</div>
							</div>
							<!-- <div class="col-md-3">
			...
			<div class="col-md-6">
				<div class="index-testimonial-card-div">
					<div class="row index-testimonial-card-row">
						...
						<div class=" col-md-11 index-testimonial-text">
							<p>My experience at Fundhouse has been good. The borrower portfolios were well-arranged and specifically informative to help me come to a decision.</p>
						</div>
					</div>
					<div class="index-testimonial-card-footer">
						<div class="row">
							<div class="col-md-9" style="margin-right: 10%;">
								...
								<div class="row text-right">Lender at Fund House</div>
							</div>
							<!-- <div class="col-md-3">
								<img role="presentation" class="img-responsive center-block"
									src="./resources/images/avatar-im1.png">
