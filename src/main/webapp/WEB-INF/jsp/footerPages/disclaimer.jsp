...
<title>Disclaimer | Fundhouse</title>
	...
	<jsp:include page="../mainHeader.jsp" flush="true"></jsp:include>
		<section class="section">
			...
			<p>&nbsp;</p>
				...
				<p>
					Fundhouse is only a marketplace connecting borrowers and lenders to facilitate a loan transaction between them. fundhouse does not guarantee borrower loans nor does it guarantee repayments to lenders. However, fundhouse does a thorough check including but not limited to document verification, accessing Credit reports and other data sources on both the borrowers and lenders before approving them on the site.
				</p>
				<p>
