...
<title>Code of Conduct of Lender | Fundhouse</title>
...
<body class="hold-transition skin-blue layout-top-nav">
	...
	<jsp:include page="../mainHeader.jsp" flush="true"></jsp:include>
		<section class="section">
			...
			<h2 class="text-center">CODE OF CONDUCT OF LENDER</h2>
			<p>&nbsp;</p>
			<p>
				<ul class="text-justify">
					...
					<li>You are permitted to download and print content from this platform solely for your own personal use to the extent required to use the services provided on this website. fundhouse supplied content must not be copied or reproduced, modified, redistributed, used or otherwise dealt with for any other reason without our express written consent.</li>
					<li>We are not responsible for content downloaded or posted by Investors on the platform.</li>
					...
					<li>You agree not to use the fundhouse website or any information accessible on or obtained from it for the purpose of canvassing or soliciting any person or enticing any person away from fundhouse.</li>
					<li>You guarantee that you have taken all reasonable precautions to ensure that any information you upload or otherwise submit to the website is free from viruses and anything else which may have a contaminating or destructive effect on any part of the website or any of its technology.</li>
